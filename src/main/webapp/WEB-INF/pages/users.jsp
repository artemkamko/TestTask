...
<center>
    ...
    <form:form method="post" action="/users/findList/">
        <label for="user"><b>Enter user name</b></label>
            <input type="text" size="60" id="user" name="user"/>
        <input type="submit" value="Search"/>
    </form:form>

    <table class="tg">
        <tr>
            <th width="80"><b>ID</b></th>
            <th width="120"><b>Name</b></th>
            <th width="120"><b>Age</b></th>
            <th width="120"><b>IsAdmin</b></th>
